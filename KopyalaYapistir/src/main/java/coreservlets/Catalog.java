...
public class Catalog {
	...
	// Burasý bir çeþit þablon 
	private static CatalogItem[] itemList = { 
			
			// CatalogItem tipinde nesneler oluþturup bunlarý bir liste içerisinde tutuyoruz
			...
			new CatalogItem(
					"hall003", 
					"<I>Kralýn Yeni Aklý</I> by Roger Penrose ",
					"" + "\n"+ " " + "\n"+ "<I>e</I>,\n"+ "<I>s</I>,\n" + "<I> "+ "</I>,\n" + "<I>e</I>, \n"+ "<I> he " + "i</I>.\n",
					99.95) 
			};

	// id verirsek , o id'ye baðlý kitap bilgilerini liste içerisinden verir
	// AllBooks'da oluþturduðum liste sadece id'leri tutuyordu.
	// Þimdi bu id'leri kontrol etmeliyim
	// Onu burada yapýyorum.
	public static CatalogItem getItem(String itemID) {
		...
		/* for (int i = 0; i < itemList.length; i++) {
			item = itemList[i];
			// item id'si kontrolü yapýlýr ve eþitlik durumunda item döndürülür.
